...
# 数据目录
DATA_DIR="/home/minxing/projects/zhiyuan/wltr/data/"
# 代码目录
...
# APP REFRESH score文件 
APP_SCORE_FRESH_FILE=${DATA_DIR}${TEST_DATE}".app.score.fresh"
...
# APP REFRESH rank数据文件
APP_FRESH_RANK_FILE=${DATA_DIR}${TEST_DATE}".app.rank.fresh"
